...
/* processor operations from r5 to a72 */
static struct remoteproc * j721e_r5_a72_proc_init(struct remoteproc *rproc,
...
static void *
j721e_r5_a72_proc_mmap(struct remoteproc *rproc, metal_phys_addr_t *pa,
...
static int j721e_r5_a72_proc_notify(struct remoteproc *rproc, uint32_t id)
{
	(void)rproc;
...
/* processor operations from r5 to a72. It defines
 * notification operation and remote processor managementi operations. */
const struct remoteproc_ops j721e_r5_a72_proc_ops = {
	.init = j721e_r5_a72_proc_init,
	.remove = j721e_r5_a72_proc_remove,
	.mmap = j721e_r5_a72_proc_mmap,
	.notify = j721e_r5_a72_proc_notify,
	.start = NULL,
	.stop = NULL,
	.shutdown = NULL,
};
...
platform_create_proc(int proc_index, int rsc_index)
{
	...
	if (!remoteproc_init(&rproc_inst, &j721e_r5_a72_proc_ops, &rproc_priv))
		return NULL;
